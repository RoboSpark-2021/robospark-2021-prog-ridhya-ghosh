// Task to do: You have to complete the Functions present on line 171 and 178.
​
#include <stdio.h>
#include <stdlib.h>
​
...
void reverse_queue_iterative(int queue)
{
    if(queue.empty())
      return ;
    int n = queue.size();
...
void reverse_queue_recursion(int q)
{
    if(q.empty())
        return;
